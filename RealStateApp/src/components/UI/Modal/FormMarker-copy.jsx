        ...
        <ModalContent>
          <ModalHeader fontSize='26px' align='center'>Create new marker</ModalHeader>
            ...
            <Formik
              ...
              <Form>  
                <ModalBody  px={10}> 
                 <FormControl h='110px' isInvalid={errors.title && touched.title}> 
                  ...
                  <FormControl h='110px' isInvalid={errors.description && touched.description}> 
                  ...
                  <FormControl h='110px' isInvalid={errors.price && touched.price}> 
                  ...
                  <FormControl  h='110px' isInvalid={errors.business_types_id && touched.business_types_id}> 
                  ...
                  <Flex h='110px' justify='space-between'>
                  ...
                  <Flex h='130px' justify='space-between'>
