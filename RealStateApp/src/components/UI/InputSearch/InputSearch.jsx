...
export default function InputSearch() {
    ...
    return ( 
        <Flex position='relative' w='100%'  alignItems='center' borderRadius='20px' h='30px' bg='#eff0f2'>
            ...
            <Input type='text' color='black' border='0px ' variant='filled'  position='relative' autoComplete='off' onChange={ev=> filterMap('title',ev.target.value)} opacity={desktopView?'0':'1'} transition='0.5s' my='20px' w='90%' sx={{'.sidebarContent:hover &':{transition : '4s', opacity:'1'}}}/>
        </Flex>
    );
  }
